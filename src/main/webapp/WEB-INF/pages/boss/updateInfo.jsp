                        ...
                        <div class="tab-pane active" id="tab-label">
                            ...
                            <div class="row data-type">
                                ...
                                <div class="col-md-4 data text">
                                    ...
                                    <input type="text" name="username" class="form-control" placeholder="商家用户名" value="${list.username}">
                                </div>

                                <div class="col-md-2 title">角色</div>
                                <div class="col-md-4 data text">
                                    <input type="text" name="role" class="form-control" placeholder="角色" value="${list.role}">
                                </div>

                                <div class="col-md-2 title">状态(0/1)</div>
                                <div class="col-md-4 data text">
                                    <input type="text" name="status" class="form-control" placeholder="状态" value="${list.status}">
                                </div>
                                <div class="col-md-2 title">真实姓名</div>
                                    <div class="col-md-4 data text">
                                        <input type="text" name="phone" class="form-control" placeholder="真实姓名" value="${list.realName}">
                                    </div>
                                <div class="col-md-2 title">手机号</div>
                                <div class="col-md-4 data text">
                                    <input type="text" name="phone" class="form-control" placeholder="手机号" value="${list.phone}">
                                </div>
                                <div class="col-md-2 title">邮箱</div>
                                <div class="col-md-4 data text">
                                    <input type="text" name="email" class="form-control" placeholder="邮箱" value="${list.email}">
                                </div>
                                <div class="col-md-2 title">地址</div>
                                <div class="col-md-4 data text">
                                    <input type="text" name="address" class="form-control" placeholder="地址" value="${list.address}">
                                </div>
                                <div class="col-md-2 title">注册时间</div>
                                <div class="col-md-4 data text">
                                    <input type="text" name="regTime" class="form-control" placeholder="注册时间" value="${list.regTime}" readonly="readonly">
                                </div>
