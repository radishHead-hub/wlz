                            ...
                            <div class="row data-type">
                                <form action="/shop/update" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-4 data text">
                                        ...
                                        <input type="text" name="shopName" class="form-control" value="${shop.shopName}">
                                    </div>
                                    <div class="col-md-2 title">店铺类型</div>
                                    <div class="col-md-4 data text">
                                        <div class="form-group">
                                            <select name="shopType" class="form-control select2" style="width: 100%;">
                                                <option selected="selected">${shop.shopType}</option>
                                                <option>火锅串串</option>
                                                <option>小吃快餐</option>
                                                <option>面包甜点</option>
                                                <option>饮品店</option>
                                    ...
                                    <div class="col-md-4 data text">
                                        <input type="text" name="shopPhone" class="form-control" value="${shop.shopPhone}">
                                    </div>
                                    <div class="col-md-2 title">营业执照号</div>
                                    <div class="col-md-4 data text">
                                        <input type="text" name="shopNo" class="form-control" value="${shop.shopNo}">
                                    </div>
                                    <div class="col-md-2 title">所属店家账户</div>
                                    <div class="col-md-4 data text">
                                        <input type="text" name="boss_name" class="form-control" value="${shop.boss_name}" readonly="readonly">
                                    </div><div class="col-md-2 title">店铺状态</div>
                                    <div class="col-md-4 data text">
                                        <input type="text" name="shopStatus" class="form-control" value="${shop.shopStatus}" readonly="readonly">
                                    </div>
                                    <div class="col-md-2 title">店铺地址<span>(详细到门牌号)</span></div>
                                    <div class="col-md-4 data text">
                                        <!--省份选择-->
                                    ...
                                    <div class="col-md-6 data text">
                                        <input type="text" class="form-control" value="${shop.shopAddress}" name="shopAddress" id="addr-show" placeholder="省-市-县、区-门牌号">
                                    </div>
                                    <div class="col-md-2 title rowHeight2x">店铺图片</div>
                                    <div class="col-md-2 data rowHeight2x">
                                        <input type="file" name="file">
                                    </div>
                                    <div class="col-md-2 data rowHeight2x" align="center">
                                        <img src="/upload/${shop.shopImg}" width="80px" height="80px"/>
                                    </div>
                                    <div class="col-md-2 title rowHeight2x">店铺介绍</div>
                                    <div class="col-md-4 data rowHeight2x">
                                        <textarea name="shopInfo" class="form-control" rows="3" placeholder="请简要介绍店铺......">${shop.shopInfo}</textarea>
                                    </div>
